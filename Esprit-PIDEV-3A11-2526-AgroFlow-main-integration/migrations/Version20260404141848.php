 ...
 */
final class Version20260404141848 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE maintenances (id INT AUTO_INCREMENT NOT NULL, id_main INT NOT NULL, type_panne VARCHAR(255) NOT NULL, cout DOUBLE PRECISION NOT NULL, date_main DATE NOT NULL, description VARCHAR(255) NOT NULL, id_m INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('ALTER TABLE rotation DROP FOREIGN KEY fk_rotation_terrain');
        $this->addSql('ALTER TABLE rotation DROP FOREIGN KEY fk_rotation_plante');
        ...
        $this->addSql('ALTER TABLE machine CHANGE dateAchat dateAchat DATE DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE participation (id_participation INT AUTO_INCREMENT NOT NULL, statut_participation VARCHAR(50) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_general_ci`, date_inscription DATE NOT NULL, presence TINYINT(1) NOT NULL, id_evenement INT DEFAULT NULL, id_user INT NOT NULL, INDEX cin (id_user), INDEX id_evenement (id_evenement), PRIMARY KEY(id_participation)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE password_resets (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, code VARCHAR(6) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci` COMMENT \'Code de vérification à 6 chiffres\', expires_at DATETIME NOT NULL COMMENT \'Date d\'\'expiration du code (15 minutes)\', created_at DATETIME DEFAULT \'current_timestamp()\' NOT NULL, used TINYINT(1) DEFAULT 0 COMMENT \'Indique si le code a été utilisé\', INDEX idx_email (email), INDEX idx_code (code), INDEX idx_expires_at (expires_at), UNIQUE INDEX unique_email (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'Table pour stocker les codes de réinitialisation de mot de passe\' ');
        $this->addSql('CREATE TABLE plante (id_plante INT AUTO_INCREMENT NOT NULL, nom_p VARCHAR(200) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_general_ci`, variete VARCHAR(200) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_general_ci`, besoin_eau FLOAT NOT NULL, cycle_jours INT NOT NULL, PRIMARY KEY(id_plante)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE rotation (id_rotation INT AUTO_INCREMENT NOT NULL, id_terrain INT NOT NULL, id_plante INT NOT NULL, date_debut_t DATE NOT NULL, date_fin_t DATE NOT NULL, status INT NOT NULL, INDEX fk_rotation_plante (id_plante), INDEX id_terrain (id_terrain, id_plante), INDEX IDX_297C98F116EBFAC1 (id_terrain), PRIMARY KEY(id_rotation)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE security_logs (id INT AUTO_INCREMENT NOT NULL, user_cin INT DEFAULT NULL, event_type VARCHAR(50) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci` COMMENT \'Type d\'\'événement (login, logout, password_change, etc.)\', event_description TEXT CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, ip_address VARCHAR(45) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, timestamp DATETIME NOT NULL, severity ENUM(\'LOW\', \'MEDIUM\', \'HIGH\', \'CRITICAL\') CHARACTER SET utf8mb4 DEFAULT \'\'\'LOW\'\'\' COLLATE `utf8mb4_unicode_ci`, INDEX idx_event_type (event_type), INDEX idx_timestamp (timestamp), INDEX idx_severity (severity), INDEX idx_user_cin (user_cin), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'Logs de sécurité pour surveiller les activités suspectes\' ');
        ...
        $this->addSql('CREATE TABLE terrain (id_terrain INT AUTO_INCREMENT NOT NULL, nom_terrain VARCHAR(50) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_general_ci`, surface FLOAT NOT NULL, type_sol VARCHAR(200) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_general_ci`, localisation VARCHAR(2000) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_general_ci`, p_h FLOAT NOT NULL, cin INT NOT NULL, INDEX cin (cin), PRIMARY KEY(id_terrain)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE rotation ADD CONSTRAINT fk_rotation_terrain FOREIGN KEY (id_terrain) REFERENCES terrain (id_terrain)');
        $this->addSql('ALTER TABLE rotation ADD CONSTRAINT fk_rotation_plante FOREIGN KEY (id_plante) REFERENCES plante (id_plante)');
        ...
        $this->addSql('ALTER TABLE machine CHANGE dateAchat dateAchat DATE NOT NULL');

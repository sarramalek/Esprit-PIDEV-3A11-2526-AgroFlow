...
use App\Entity\Examen; // Corrigé
use App\Form\ExamenType; // Corrigé (vérifie que ton fichier est src/Form/ExamenType.php)
use App\Repository\ExamenRepository; // Corrigé

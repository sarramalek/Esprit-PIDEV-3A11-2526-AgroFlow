...
#[Route('/ouvrier/participations')]
#[IsGranted('ROLE_OUVRIER')]
class ParticipationController extends AbstractController
{
    #[Route('/', name: 'ouvrier_participation_index')]
    public function index(Request $request, ParticipationRepository $repo): Response
    {
        ...
        return $this->render('Evenements/indexParticipationOuvrier.html.twig', [
    ...
    #[Route('/modifier/{id}', name: 'ouvrier_participation_modifier', methods: ['GET', 'POST'])]
    public function modifier(int $id, Request $request, ManagerRegistry $doctrine, ParticipationRepository $repo): Response
    {
        ...
        return $this->render('Evenements/modifierParticipationOuvrier.html.twig', [
            'form' => $form->createView(),
            'participation' => $participation,
        ]);
    }

    #[Route('/annuler/{id}', name: 'ouvrier_participation_annuler', methods: ['POST'])]
